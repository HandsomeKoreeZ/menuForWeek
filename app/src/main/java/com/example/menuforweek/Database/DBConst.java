...
public class DBConst {
    ...
    public static final String COL_TEXT_ID = "id_text";
    ...
    public static final String CREATE_REC_TEXT = "CREATE TABLE "+TAB_REC_TEXT+ " ( "+
            COL_ID+" int primary key," +
            COL_REC_TEXT + " text)";
    ...
    public static final String CREATE_RECIPE  = "CREATE TABLE "+TAB_RECIPE+ " ("+
            ...
            "FOREIGN KEY("+COL_TEXT_ID+") REFERENCES " +TAB_REC_TEXT+" ("+COL_ID+"))";
